...
export const EXTRACTED_KEYS = [
  ...
  'material', 'coating', 'workpieceMats', 'tipAngle', 'helixAngle', 'pitch',
...
export function sanitizeExtraction(p) {
  ...
  for (const k of [
    'diameter', 'loc', 'oal', 'flutes', 'shankDia', 'coating', 'tipAngle',
