...
export default function MergeFlow() {
  ...
  // Last program (program # + part #) picked in CommitStep — carried to the next
  // queue item's commit screen, since a batch sync is usually all one program.
  const [lastProgramInput, setLastProgramInput] = useState(null);
          ...
          <div className="merge-queue-main">
            ...
            {subStep === 'commit' && masterTool && (
              <CommitStep
                ...
                initialProgram={lastProgramInput}
                onProgramInput={setLastProgramInput}
