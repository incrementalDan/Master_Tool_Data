...
export const DEFAULT_MATERIALS = {
  ...
  presets: [
    ...
    // P — Steel
    { id: 'pre_P_free',        group_id: 'P', name: 'Steel Free Machining',   code: 'STEEL',    description: 'Leaded & resulfurized (12L14, 1213)',            iso_513: 'P1.3', kennametal: 'P1', vdi_3323: '1', order: 5 },
    { id: 'pre_P_1144',        group_id: 'P', name: 'Steel 1144 Stressproof', code: 'STEEL',    description: 'Resulfurized med-C — Kennametal uses P2',        iso_513: 'P1.1', kennametal: 'P2', vdi_3323: '2', order: 6 },
    ...
    { id: 'pre_K_ductile_hi',  group_id: 'K', name: 'Ductile Iron High Str', code: 'CI',       description: 'High strength and ADI ductile iron',           iso_513: 'K3.3', kennametal: 'K3', vdi_3323: '18', order: 20 },
    // S — High Temp Alloys
    { id: 'pre_S_titan',       group_id: 'S', name: 'Titanium',               code: 'TI',       description: 'CP Ti and Ti-6Al-4V',                           iso_513: 'S1.2', kennametal: 'S4', vdi_3323: '37', order: 21 },
    { id: 'pre_S_nickel',      group_id: 'S', name: 'Inconel / Ni Alloy',     code: 'INC',      description: 'Ni-based superalloys (625, 718, Hastelloy)',    iso_513: 'S3.1', kennametal: 'S3', vdi_3323: '34', order: 22 },
    { id: 'pre_S_fe_hta',      group_id: 'S', name: 'Fe-Based HTA',           code: 'HTA',      description: 'Fe-based high-temp alloys (A-286)',             iso_513: 'S2.2', kennametal: 'S1', vdi_3323: '31', order: 23 },
    { id: 'pre_S_co_hta',      group_id: 'S', name: 'Co-Based HTA',           code: 'HTA',      description: 'Co-based high-temp alloys (Stellite)',          iso_513: 'S4.2', kennametal: 'S2', vdi_3323: '33', order: 24 },
    // H — Hardened Steel
...
export const DEFAULT_SHOP_SETTINGS = {
  ...
  // shop-wide, shared across every device via Drive; the UI's boolean "done" map
  // is derived from it (setupProgressFromSteps). proshopPhotos is a sub-step of
  // proshopMerged.
  setup_steps: {
